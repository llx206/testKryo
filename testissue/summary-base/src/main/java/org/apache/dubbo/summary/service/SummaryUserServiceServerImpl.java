...
public class SummaryUserServiceServerImpl implements SummaryUserService {
    ...
    public SummaryPage<SummaryUser> listUser(int pageNo) {
        List<SummaryUser> userList = new ArrayList<>(15);
        ...
        SummaryPage<SummaryUser> page = new SummaryPage<>();
